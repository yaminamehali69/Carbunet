...
with tabs[1]:
        ...
        if df is not None:
            ...
            # 🗺️ 4. AFFICHAGE DES RÉSULTATS (Parfaitement imbriqué ici)
                    ...
                    try:
                        ...
                        if loc:
                            ...
                            if not res.empty:
                                ...
                                # Cartes HTML des stations en liste en dessous de la carte (Alignement Python corrigé)
